...
class Simulation3d:
    ...
    def initialize(self, namelist):
        ...
        if self.Restart.is_restart_run:
            if not self.Restart.is_altered:
                ...
                self.RS.init_from_restart(self.Gr, self.Restart, self.StatsIO, self.Pa)
                ...
                FillAlteredFields(namelist,self.Gr, self.PV, self.RS, self.Th, self.StatsIO, self.Pa, self.LH, self.Restart)
    ...
    def run(self):
        ...
        self.Fo.update(self.Gr, self.RS, self.PV, self.DV, self.TS, self.Pa)
        ...
        self.Damping.update(self.Gr, self.RS,self.PV, self.DV, self.Pa, self.TS)
    ...
    def io(self):
        ...
        if self.TS.t > 0 and self.TS.rk_step == self.TS.n_rk_steps - 1:
            ...
            if self.FieldsIO.last_output_time + self.FieldsIO.frequency == self.TS.t:
                ...
                self.FieldsIO.dump_vmr(self.Gr, self.PV, self.DV, self.RS)
